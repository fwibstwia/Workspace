...
match v, s with
|v, nil => nil
|v, m::l' => match beq_nat v m with
               |true => l'
               |false => m::remove_one v l'
             end
end.
...
|n::l',  nil => false
|nil, n::l' => true
|n::l1, m::l2 => match count n s2 with
                   |O => false
                   |S k => subset l1 (remove_one n s2)
                 end
end.
...
|n::l', nil => false
|nil, n::l' => false
|m::l1', n::l2' => match beq_nat m n with
